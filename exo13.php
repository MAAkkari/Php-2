...
suivants :
    ...
    Class Voiture{
        ...
        public function accelerer(int $accel){
            ...
            else{echo"<br>"."<br>"."Le vehicule $this->_marque $this->_modele veux accélérer de $accel km / h"."<br>"."<br>"."pour accélerer, il faut démarrer le vehicule $this->_marque $this->_modele !";}
        }
        ...
        function ralentir(int $decel){
            if ($this->_etat==true && $this->_vitesseActuelle>=$decel){
                ...
                else{echo"<br>"."<br>"."Le vehicule $this->_marque $this->_modele veux ralentir de $decel"."<br>"."<br>"."Cependant la vitesse est deja de $this->_vitesseActuelle km / h !";}
        }
